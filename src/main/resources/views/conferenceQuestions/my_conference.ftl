        ...
        <form class="layui-form">
            ...
            <div class="layui-input-inline">
                <select name="rankId" id="rank">
                    ...
                    <option value="1" <#if conferenceNowQuery.rankId?? && conferenceNowQuery.rankId==1>selected</#if>>班级会议</option>
                    <option value="2" <#if conferenceNowQuery.rankId?? && conferenceNowQuery.rankId==2>selected</#if>>小组会议</option>
                </select>
            </div>
            <div class="layui-input-inline">
...
<ul class="layui-timeline" id="timeline">
    <#if conferences??>
        <#list conferences as conference>
            <li class="layui-timeline-item layui-col-md12">
