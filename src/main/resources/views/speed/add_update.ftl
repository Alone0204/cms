...
<form class="layui-form" style="width:80%;">
    <input type="hidden" name="id"  value="<#if (speed.id)??>${(speed.id)!}</#if>">
    <input type="hidden" name="userId"  value="<#if (speed.userId)??>${(speed.userId)!}</#if>">

    <div class="layui-form-item layui-row layui-col-xs12">
        <div class="layui-col-xs4">
            <label class="layui-form-label">视频进度</label>
